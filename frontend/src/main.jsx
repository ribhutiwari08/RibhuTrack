...
function AuthGate(){const [mode,setMode]=useState(localStorage.getItem('rt_token')?'app':'signup');if(mode==='signup')return <Signup onSignIn={()=>setMode('app')} onRegistered={()=>setMode('app')}/>;return <App/>}
